...
#Bishop moves are eliminated by using set() and number of queens, N. We will check Bishop for both diagonals. If there is no overlap, the set of 8 diagonals will be unique and will have lenght 8.
